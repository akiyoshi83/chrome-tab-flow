...
var u = _interopRequireWildcard(_utilsUtil);

var _modelsBookmark = require('../models/bookmark');

var _modelsBookmark2 = _interopRequireDefault(_modelsBookmark);
...
var vm = {
  init: function init() {
    vm.keyword = _mithril2['default'].prop("");
    vm.list = _mithril2['default'].prop([]);
    _modelsBookmark2['default'].fetch().then(function (data) {
      vm.list = data;
      _mithril2['default'].redraw();
    });

    vm.filter = function () {
      return _modelsBookmark2['default'].filter(vm.list(), vm.keyword());
    };
  }
};
...
var Bookmarks = {
  controller: function controller() {
    vm.init();
    this.updateKeyword = function (ev) {
    ...
    this.keydown = function (ev) {
      ...
      // Enter
      if (kc === 13) {
        var bookmark = vm.list().find(function (t) {
          return t.id() == target.dataset.bookmarkId;
        });
        bookmark.open();
      }
      // UP, K
  ...
  view: function view(ctrl) {
    return (0, _mithril2['default'])('.bookmarks', [_mithril2['default'].component(_header2['default']), (0, _mithril2['default'])('.input_area', [(0, _mithril2['default'])('input[type="text"]#bookmark_search_box.search', {
      placeholder: u.m('placeholderSearch'),
      value: vm.keyword(),
      onkeyup: ctrl.updateKeyword,
      config: function config(elem, isInitialized, context) {
        if (!isInitialized) elem.focus();
      }
    })]), (0, _mithril2['default'])('.output_area', [(0, _mithril2['default'])('ul.bookmarks', vm.filter().map(function (bookmark) {
      return (0, _mithril2['default'])('li.bookmark', {
        tabIndex: 0, // form要素以外にfocusを当てるために
        'data-bookmark-id': bookmark.id(),
        onkeydown: ctrl.keydown,
        onfocus: ctrl.focus,
        onblur: ctrl.blur
      }, [(0, _mithril2['default'])('.name', bookmark.title()), (0, _mithril2['default'])('.url', bookmark.url())]);
    }))])]);
  }
};
...
},{"../models/bookmark":5,"../utils/util":8,"./header":3,"mithril":1}],3:[function(require,module,exports){
'use strict';
...
var Header = {
  controller: function controller() {
    this.showTabs = function (ev) {
      _mithril2['default'].route('/tabs');
    };
    this.showBookmarks = function (ev) {
      _mithril2['default'].route('/bookmarks');
    };
  },
  view: function view(ctrl) {
    return (0, _mithril2['default'])('.header', [(0, _mithril2['default'])('a.tabs', {
      'class': _mithril2['default'].route() === '/tabs' ? 'selected' : '',
      onclick: ctrl.showTabs
    }, 'TAB'), (0, _mithril2['default'])('a.bookmarks', {
      'class': _mithril2['default'].route() === '/bookmarks' ? 'selected' : '',
...
var _modelsTab = require('../models/tab');

var _modelsTab2 = _interopRequireDefault(_modelsTab);
...
var TabsVm = {
  init: function init() {
    TabsVm.keyword = _mithril2['default'].prop("");

    TabsVm.list = _mithril2['default'].prop([]);
    _modelsTab2['default'].fetch().then(function (data) {
      TabsVm.list = data;
      _mithril2['default'].redraw();
    });

    TabsVm.filter = function () {
      return _modelsTab2['default'].filter(TabsVm.list(), TabsVm.keyword());
    };
  }
};
...
var Tabs = {
  controller: function controller() {
    ...
    this.keydown = function (ev) {
      ...
      // Enter
      if (kc === 13) {
        var tab = TabsVm.list().find(function (t) {
          return t.id() == target.dataset.tabId;
        });
        tab.activate();
      }
      // UP, K
  ...
  view: function view(ctrl) {
    return (0, _mithril2['default'])('.tabs', [_mithril2['default'].component(_header2['default']), (0, _mithril2['default'])('.input_area', [(0, _mithril2['default'])('input[type="text"]#tab_search_box.search', {
      placeholder: u.m('placeholderSearch'),
    ...
    })]), (0, _mithril2['default'])('.output_area', [(0, _mithril2['default'])('ul.tabs', TabsVm.filter().map(function (tab) {
      return (0, _mithril2['default'])('li.tab', {
        tabIndex: 0, // form要素以外にfocusを当てるために
        'data-tab-id': tab.id(),
        onkeydown: ctrl.keydown,
        onfocus: ctrl.focus,
        onblur: ctrl.blur
      }, [(0, _mithril2['default'])('.name', tab.title()), (0, _mithril2['default'])('.url', tab.url())]);
    }))])]);
  }
};
...
},{"../models/tab":6,"../utils/util":8,"./header":3,"mithril":1}],5:[function(require,module,exports){
'use strict';
...
var Bookmark = (function () {
  function Bookmark(data) {
    ...
    this.url = _mithril2['default'].prop(data.url);
    this.categories = _mithril2['default'].prop(data.categories);
  }
    ...
    value: function fetch() {
      return new Promise(function (resolve) {
        chrome.bookmarks.getTree(function (tree) {
          ...
          resolve(_mithril2['default'].prop(results));
        });
      });
    }
  }, {
    key: 'filter',
    value: function filter(bookmarks, keyword) {
      if (!keyword) {
        return bookmarks;
      }
      var _k = keyword.toLowerCase();
      return bookmarks.filter(function (bookmark) {
        var title = bookmark.title().toLowerCase();
        var url = bookmark.url().toLowerCase();
        var categories = bookmark.categories().toLowerCase();
...
var Tab = (function () {
  function Tab(data) {
    ...
    this.id = _mithril2['default'].prop(data.id);
    this.windowId = _mithril2['default'].prop(data.windowId);
    this.title = _mithril2['default'].prop(data.title);
    this.url = _mithril2['default'].prop(data.url);
  }
  ...
  _createClass(Tab, [{
    ...
    value: function activate() {
      ...
      return new Promise(function (resolve, reject) {
        if (typeof _this.id() === 'undefined' || typeof _this.windowId() === 'undefined') {
          reject(new Error('argument 1: tab is required'));
        }
        var windowId = _this.windowId();
        var tabId = _this.id();
        // activate window
    ...
    value: function fetch() {
      return new Promise(function (resolve) {
        chrome.tabs.query({}, function (tabs) {
          ...
          resolve(_mithril2['default'].prop(tabs));
        });
      });
    }
  }, {
    key: 'filter',
    value: function filter(tabs, keyword) {
      if (!keyword) {
        return tabs;
      }
      var _k = keyword.toLowerCase();
...
var _componentsBookmarks = require('./components/bookmarks');

var _componentsBookmarks2 = _interopRequireDefault(_componentsBookmarks);

var main = document.getElementById('main');

_mithril2['default'].route(main, '/tabs', {
  '/tabs': _componentsTabs2['default'],
  '/bookmarks': _componentsBookmarks2['default']
});

},{"./components/bookmarks":2,"./components/tabs":4,"mithril":1}],8:[function(require,module,exports){
"use strict";
