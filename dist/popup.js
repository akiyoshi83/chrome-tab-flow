...
var Bookmarks = {
  controller: function controller() {
    ...
    this.keydown = function (ev) {
      ...
      // Enter
      if (kc === 13) {
        _modelsBookmark2['default'].open(vm.list().find(function (t) {
...
var Tabs = {
  controller: function controller() {
    ...
    this.keydown = function (ev) {
      ...
      // Enter
      if (kc === 13) {
        _modelsTab2['default'].activate(TabsVm.list().find(function (t) {
...
var Tab = (function () {
  ...
  _createClass(Tab, null, [{
    ...
    value: function activate(tab) {
      return new Promise(function (resolve, reject) {
        if (typeof tab.id() === 'undefined' || typeof tab.windowId() === 'undefined') {
